...
function renderSearchSuggestions(query) {
  ...
  shown.forEach(g => {
    ...
    item.innerHTML = `<span class="search-suggestion-name">${g.nombre}</span><span class="search-suggestion-meta">${g.precio != null ? formatPrice(g.precio) + " · " : ""}${d ? d.nombre : ""}</span>`;
    item.onclick = () => {
...
function renderGrid() {
  ...
  list.forEach(g => {
    ...
    body.innerHTML = `
      ...
      ${g.precio != null ? `<div class="gcard-price">${formatPrice(g.precio)}</div>` : ""}
...
function openModal(g, opts = {}) {
  ...
  if (g.precio != null) { $("#modalPrecio").textContent = formatPrice(g.precio); $("#modalPrecioWrap").style.display = ""; }
